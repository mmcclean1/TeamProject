...
<!--			LOGIN IN FORM-->
				<form action="register.php" method="POST">
					...
					<br>
					<a href="#" id="signup" class="signup"  style="color: gold;">Need an account? Register here!</a>
...
<!--					<input type="file" name="profile_pic"/>-->
					...
					<a href="#" id="signin" class="signin" style="color: gold;">Already have an account? Sign in here!</a>
				</form>
			</div>
